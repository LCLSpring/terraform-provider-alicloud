...
* `environment_info` - (Computed) The environment information of the route. See [`EnvironmentInfo`](#EnvironmentInfo) below.
* `http_api_id` - (ForceNew, Optional) The ID of the HTTP API to which the route belongs.
* `route_name` - (ForceNew, Optional) The name of the route.
* `status` - (ForceNew, Optional) The deployment status of the route.
...
The GatewayInfo supports the following:
* `gateway_id` - (ForceNew, Optional) The ID of the Cloud-native API Gateway.
#### Block EnvironmentInfo

The EnvironmentInfo supports the following:
* `environment_id` - (ForceNew, Optional) The environment ID.
* `gateway_info` - (Computed) The gateway instance information corresponding to the environment. See [`GatewayInfo`](#GatewayInfo) below.
