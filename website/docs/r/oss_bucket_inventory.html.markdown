...
* `destination` - (Optional, Set) Holds the container that holds the location of the inventory results. See [`destination`](#destination) below.
...
* `incremental_inventory` - (Optional, Set) Configuration container for incremental inventory See [`incremental_inventory`](#incremental_inventory) below.
