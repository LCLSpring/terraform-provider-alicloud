...
* `order_type` - (Optional, Computed, Available since v1.274.0) The entity that pays the fees of the network instance. Valid values:
...
```shell
$ terraform import alicloud_cen_transit_router_vbr_attachment.example <transit_router_attachment_id>
```