	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"domain_ids", "route_name"},
			},
		},
	})
}
...
resource "alicloud_apig_http_api" "route_httpapi_arr2" {
  http_api_name = "cspec-route-arr2-httpapi"
  protocols     = ["HTTP"]
  type          = "Rest"
  description   = "array2 test httpapi"
  base_path     = "/cspec-route-arr2"
}
...
resource "alicloud_apig_http_api" "defaultapi" {
  http_api_name = "test-api-1783596037"
  type          = "Http"
...
resource "alicloud_apig_environment" "defaultenvironment" {
  description      = "镇元测试环境"
  environment_name = "test-env-1783596045"
  gateway_id       = alicloud_apig_gateway.defaultgateway.id
}

resource "alicloud_apig_service" "defaultservice1" {
  service_name = "test-1783596045"
  source_type  = "DNS"
  gateway_id   = alicloud_apig_gateway.defaultgateway.id
  addresses    = ["${var.dns_address}"]
}
...
resource "alicloud_apig_http_api" "defaultapi" {
  http_api_name = "test-api-1783596046"
  type          = "Http"
  description   = "test api"
  protocols     = ["${var.protocol}"]
}
...
resource "alicloud_apig_domain" "defaultdomain2" {
  domain_name = "zhenyuan-test-2.com"
  protocol    = "HTTP"
}

resource "alicloud_apig_domain" "defaultdomain3" {
  domain_name = "zhenyuan-test-3.com"
  protocol    = "HTTP"
}

resource "alicloud_apig_environment" "defaultenvironment" {
  description      = "镇元测试环境"
  environment_name = "test-env-1783596054"
  gateway_id       = alicloud_apig_gateway.defaultgateway.id
}

resource "alicloud_apig_service" "defaultservice1" {
  service_name = "test-1783596055"
  source_type  = "DNS"
  gateway_id   = alicloud_apig_gateway.defaultgateway.id
  addresses    = ["${var.dns_address}"]
}
...
resource "alicloud_apig_http_api" "defaultapi" {
  http_api_name = "test-api-1783596056"
  type          = "Http"
  description   = "test api"
  protocols     = ["${var.protocol}"]
}
...
resource "alicloud_apig_environment" "defaultenvironment" {
  description      = "镇元测试环境"
  environment_name = "test-env-1783596062"
  gateway_id       = alicloud_apig_gateway.defaultgateway.id
}

resource "alicloud_apig_service" "defaultservice1" {
  service_name = "test-1783596063"
  source_type  = "DNS"
  gateway_id   = alicloud_apig_gateway.defaultgateway.id
  addresses    = ["${var.dns_address}"]
}
...
resource "alicloud_apig_http_api" "defaultapi" {
  http_api_name = "test-api-1783596063"
  type          = "Http"
  description   = "test api"
  protocols     = ["${var.protocol}"]
}
